/* Chỉ đổi số này khi sửa index.html hoặc sw.js.
   Cập nhật nội dung thì chỉ thay data.js — tệp đó luôn được lấy mới. */
const CACHE = 'thong-tin-thuoc-2026-08-15-2';
const ASSETS = ['./','./index.html','./data.js','./bien-tap.html','./manifest.webmanifest',
...
self.addEventListener('fetch',e=>{
  ...
  if(new URL(req.url).pathname.endsWith('/data.js')) return e.respondWith(fresh(req));
